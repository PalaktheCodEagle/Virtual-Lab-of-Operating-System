            ...
            try{
                ...
                if($rs = $statement->fetch()){
                    ...
                    $mail_body = '<html>
                        ...
                        <p><a href="http://vlabcomp.kjsieit.in/forgot_password.php"> Reset Password</a></p>
                        <p><strong>&copy;'.date('Y').' KJSIT</strong></p>
                        </body>
                        </html>';

                    $mail->addAddress($email, $username);
                    $mail->Subject = "Password Recovery Message from KJSIT";
                    $mail->Body = $mail_body;
