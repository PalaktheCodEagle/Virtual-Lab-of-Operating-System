            ...
            if ($row = $statement->fetch()){
                ...
                if ($deactivateQuery->rowCount() === 1){
                    ...
                    if ($insertRecord->rowCount() === 1){
                        ...
                        //prepare email body
                        $mail_body = '<html>
                        <body style="background-color:#CCCCCC; color:#000; font-family: Poppins, 
                            ...
                            <p><a href="http: //vlabcomp.kjsieit.in/login.php">Sign In</a></p>
                            <p><strong>&copy;2022 KJSIT</strong></p>
                        </body>
                        </html>';

                        $mail->addAddress($email, $username);
                        $mail->Subject = "Message from KJSIT Account Deactivated";
                        $mail->Body = $mail_body;
